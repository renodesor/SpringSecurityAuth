...
/*
		...
		if(idToken != null) {
			...
			protectedInfo.append("Token mapped values "+idToken.getTokenValue()+"<br><br>");
			...
			userDetails.forEach((u,v) -> System.out.println(u+" -> "+v));
		}
*/		
	...
	private StringBuffer getUsernamePasswordLoginInfo(Principal user) {
		...
		if(token.isAuthenticated()) {
			...
			usernameInfo.append("Welcome, "+u.toString());
		}else {
